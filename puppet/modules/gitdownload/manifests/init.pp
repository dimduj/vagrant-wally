...
class nginx {
  ...
  file { '/var/www/wally':
    ...
    target  => '/vagrant/wally/core',
  }
  # Symlink /var/www/app on our guest with
  # host /path/to/vagrant/app on our system
  file { '/var/www/wally/sites/all/modules':
    ensure  => 'link',
    target  => '/vagrant/wally/integrations/modules',
  }
  # Symlink /var/www/app on our guest with
  # host /path/to/vagrant/app on our system
  file { '/var/www/wally/sites/all/themes':
    ensure  => 'link',
    target  => '/vagrant/wally/integrations/themes',
  }
